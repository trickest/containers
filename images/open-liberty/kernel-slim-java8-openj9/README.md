# [open-liberty:kernel-slim-java8-openj9](https://hub.docker.com/_/open-liberty?tab=tags)
![](https://img.shields.io/static/v1?label=tag&message=kernel-slim-java8-openj9&color=blue)
