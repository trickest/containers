# [ibm-semeru-runtimes:open-8-jdk-focal](https://hub.docker.com/_/ibm-semeru-runtimes?tab=tags)
![](https://img.shields.io/static/v1?label=tag&message=open-8-jdk-focal&color=blue)
