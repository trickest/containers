# [ibm-semeru-runtimes:open-17-jdk](https://hub.docker.com/_/ibm-semeru-runtimes?tab=tags)
![](https://img.shields.io/static/v1?label=tag&message=open-17-jdk&color=blue)
