# [mediawiki:legacylts-fpm-alpine](https://hub.docker.com/_/mediawiki?tab=tags)
![](https://img.shields.io/static/v1?label=tag&message=legacylts-fpm-alpine&color=blue)
