# [joomla:3.10-php7.4-fpm-alpine](https://hub.docker.com/_/joomla?tab=tags)
![](https://img.shields.io/static/v1?label=tag&message=3.10-php7.4-fpm-alpine&color=blue)
